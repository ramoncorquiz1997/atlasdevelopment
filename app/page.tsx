...
export default function Discor() {
  return (
    <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <header className="fixed inset-x-0 top-0 z-50 backdrop-blur-xl bg-black/5 dark:bg-black/30 border-b border-border shadow-[0_1px_0_0_rgba(0,0,0,0.05)]">
      ...
      {/* Wrapper con padding-top para que no se esconda bajo el header */}
